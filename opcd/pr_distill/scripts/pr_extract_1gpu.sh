#!/bin/bash
# PR-OPCD: On-policy extract step
# Student generates responses on plain prompts (no hint)
...
VAL_SAMPLES_LIMIT="${VAL_SAMPLES_LIMIT:-1000}"
PROMPT_VERSION="${PROMPT_VERSION:-pr}"
